      ...
      <section id="main-cate-edit-content">
          ...
          <div class="input-editDMSP-frame">
            <div class="category-input-frame">
              <div class="input-DM-frame">
                <label for="MaDMSP" class="form-DMSP-label">Mã danh mục</label>
                <input type="text" id="MaDMSP" class="input-ten-dm" />
              </div>
              <div class="input-DM-frame">
                <label for="TenDMSP" class="form-DMSP-label"
                  >Tên danh mục</label
                >
                <input type="text" id="TenDMSP" class="input-ten-dm" />
              </div>
            </div>
            <div class="category-input-note">
              <label for="MoTaDMSP" class="form-DMSP-label"
                >Mô tả (nếu có)
              </label>
        ...
        <div id="thmDanhMc" class="popup-overlay" style="display: none">
          <div class="alert-add-dmsp">
            ...
            <img
              class="alert-add-dmsp--img"
              loading="lazy"
              alt=""
              src="./icon/group-1000006814.svg"
            />
          </div>
        </div>
      </section>
    ...
    <script>
      ...
      if (groupIcon) {
        groupIcon.addEventListener("click", function (e) {
          window.location.href = "./qly-loai-sp.html"; //nhấn nút back quay lại qly loại sp
        });
      }
